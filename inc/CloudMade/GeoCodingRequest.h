...
//! Class makes request for geocoding search to get result GeoCodingResult has to be adopted \sa GeoCodingResult
 ...
 *  @param city city name 
 *  @param postcode postcode 
 *  @param county county in where search should be done  
 *  @param country country in where search should be done  
 */
